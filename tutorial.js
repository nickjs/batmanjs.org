...
expect(/@persist\s*Batman.RailsStorage/, {
  "in": 'models/article.js.coffee'
});
...
expect(/index:\s*\(params\)\s*->/, {
  "in": 'controllers/artists_controller.js.coffee'
});

expect(/show:\s*\(params\)\s*->/, {
  "in": 'controllers/artists_controller.js.coffee'
});

expect(/new:\s*\(params\)\s*->/, {
  "in": 'controllers/artists_controller.js.coffee'
});
