...
(function() {
  ...
  Try.CodeStep = (function(_super) {
    ...
    function CodeStep() {
      CodeStep.__super__.constructor.apply(this, arguments);
      this.matches = {};
    }
    ...
    CodeStep.prototype.expect = function(filename, regex) {
      var _base;
    ...
    success: function(content) {
      ...
      return Try.File.load(function() {
        ...
        return $('#terminal-field').on('keydown', function(e) {
          var _ref5;
          if (e.keyCode === 13) {
            return (_ref5 = Try.get('currentStep')) != null ? _ref5.check(this.value) : void 0;
          }
        });
      });
    }
